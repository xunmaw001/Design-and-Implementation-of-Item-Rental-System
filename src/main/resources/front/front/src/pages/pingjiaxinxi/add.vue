...
<div :style='{"padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"20px auto 30px","borderRadius":"20px","background":"#fff","width":"1100px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="信用评价" prop="xinyongpingjia">
            <el-select v-model="ruleForm.xinyongpingjia" placeholder="请选择信用评价"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="评价时间" prop="pingjiashijian" >
              <el-date-picker
