	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="信用评价" prop="xinyongpingjia">
					<el-select :disabled="ro.xinyongpingjia" v-model="ruleForm.xinyongpingjia" placeholder="请选择信用评价" >
						<el-option
							v-for="(item,index) in xinyongpingjiaOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="信用评价" prop="xinyongpingjia">
					<el-input v-model="ruleForm.xinyongpingjia"
						placeholder="信用评价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="评价时间" prop="pingjiashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.pingjiashijian" label="评价时间" prop="pingjiashijian">
	...
	data() {
		...
		return {
			...
			rules: {
				...
				xinyongpingjia: [
					{ required: true, message: '信用评价不能为空', trigger: 'blur' },
				],
				pingjiashijian: [
				],
				wodezhanghao: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xinyongpingjia'){
							this.ruleForm.xinyongpingjia = obj[o];
							this.ro.xinyongpingjia = true;
							continue;
						}
						if(o=='pingjiashijian'){
            ...
            this.xinyongpingjiaOptions = "5分,4分,3分,2分,1分".split(',')
            this.$http({
